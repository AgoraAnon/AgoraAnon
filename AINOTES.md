...
Read `~/xuserbin/AINOTES.md` first for host-level shell, workspace, toolchain, and Claude/Codex handoff rules.

## Project Summary

- Path: `~/xuserbin/projects/agoraanon`
- Repo: `git@github.com:AgoraAnon/AgoraAnon`
- Branch: `main`
...
- Update the host-level `AINOTES.md` only when durable cross-project or system facts change.
